...
ARG WORKSPACE_DIR
ARG VLLM_VERSION=0.2.2.dev31+ge5df23358
...
RUN --mount=type=cache,target=/root/.cache/pip \
    --mount=type=secret,id=catoken,env=CODEARTIFACT_AUTH_TOKEN \
    pip install vllm[runai,tensorizer,fastsafetensors]==${VLLM_VERSION} \
    --extra-index-url https://aws:${CODEARTIFACT_AUTH_TOKEN}@dottxt-ai-242201295967.d.codeartifact.us-east-1.amazonaws.com/pypi/dottxt-ai-external/simple
